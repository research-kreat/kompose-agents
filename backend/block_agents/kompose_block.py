...
class KomposeBlockHandler(BaseBlockHandler):
    ...
    def process_message(self, user_message, flow_status):
        ...
        return {
            "suggestion": "Would you like to generate a business idea using our feature?"
        }
    
    def get_kompose_tasks(self, user_prompt=None):
        """
        Get all Kompose tasks without executing them
    ...
    def _create_task_definitions(self, user_prompt=None):
        ...
        Returns:
            list: All task definitions
        """
        initial_user_input = user_prompt or ""
